...
<div class="login">
    <form id="loginForm" action="${pageContext.request.contextPath}/ad/login" method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/img/captcha.jpg" title="点击更换验证码"/>
                </td>
            </tr>
            <tr>
                <td>
